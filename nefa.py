...
if prediction == 1:
    st.write("Stroke: "+'%'+str(accuracy_score(Y_test, RandomForestClassifier.predict(X_test)) * 10000/100))
else:
    st.write("Not stroke: "+'%'+str(accuracy_score(Y_test, RandomForestClassifier.predict(X_test)) * 10000/100))
